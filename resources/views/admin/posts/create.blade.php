                ...
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    <form action="{{ route('admin.posts.store') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" name="title" id="title" class="w-full bg-gray-900 border-gray-700 rounded shadow-sm text-white" required>
                        </div>

                        <div class="mb-4">
                            <label for="content" class="block text-sm font-medium mb-1">İçerik</label>
                            <textarea name="content" id="content" rows="10" class="w-full bg-gray-900 border-gray-700 rounded shadow-sm text-white" required></textarea>
                        </div>
