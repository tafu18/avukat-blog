                ...
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    <form action="{{ route('admin.posts.store') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div id="tabContent">
                            ...
                            <div class="hidden p-4 rounded-lg bg-gray-900 border border-gray-700 block" id="tr" role="tabpanel" aria-labelledby="tr-tab">
                                <div class="mb-4">
                                    ...
                                    <input type="text" name="title" id="title" class="w-full bg-gray-800 border-gray-600 rounded shadow-sm text-white focus:border-indigo-500 focus:ring-indigo-500" required>
                                </div>
                                <div class="mb-4">
                                    <label for="content" class="block text-sm font-medium mb-1 text-gray-300">İçerik (TR)</label>
                                    <textarea name="content" id="content" rows="10" class="w-full bg-gray-800 border-gray-600 rounded shadow-sm text-white focus:border-indigo-500 focus:ring-indigo-500" required></textarea>
                                </div>
                            </div>
                            ...
                            <div class="hidden p-4 rounded-lg bg-gray-900 border border-gray-700" id="en" role="tabpanel" aria-labelledby="en-tab">
                                <div class="mb-4">
                                    ...
                                    <input type="text" name="title_en" id="title_en" class="w-full bg-gray-800 border-gray-600 rounded shadow-sm text-white focus:border-indigo-500 focus:ring-indigo-500">
                                </div>
                                <div class="mb-4">
                                    <label for="content_en" class="block text-sm font-medium mb-1 text-gray-300">Content (EN)</label>
                                    <textarea name="content_en" id="content_en" rows="10" class="w-full bg-gray-800 border-gray-600 rounded shadow-sm text-white focus:border-indigo-500 focus:ring-indigo-500"></textarea>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="mb-6 flex items-center">
                            <input type="checkbox" name="is_published" id="is_published" class="rounded bg-gray-900 border-gray-700 text-indigo-600 shadow-sm focus:ring-indigo-500">
                            <label for="is_published" class="ml-2 text-sm">Yayınla</label>
                        </div>

                        <div class="flex gap-4">
                            <button type="submit" class="px-6 py-2 bg-indigo-600 rounded text-white font-bold hover:bg-indigo-500">Kaydet</button>
